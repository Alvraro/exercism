...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    reactor_efficiency_number = (generated_power / theoretical_max_power) * 100

    if reactor_efficiency_number >= 80:
        return "green"
    elif reactor_efficiency_number >= 60:
        return "orange"
    elif reactor_efficiency_number >= 30:
        return "red"
    else:
        return "black"
